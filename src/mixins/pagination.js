import {setQuery,} from '../assets/js/utils';
import Api from '../assets/js/get';
...
export default {
  ...
  methods: {
    load({per_page = this.pageSize, page = 1, sort, filters, search}, append = false) {
      ...
      return Api.getData(this.apiUrl, Object.assign(params, filters), this.cacheExpire).then(response => {
